...
In AI, these concepts can be separated, as to say there is a learning, and an applied phase, where the logical thinking comes into play. % examples+more detailed
...
\subsection{Overfitting}\label{sec:overfit}
